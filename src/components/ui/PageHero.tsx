...
export default function PageHero({
  ...
  return (
    <section className="w-full bg-canvas pt-[140px] pb-16">
      <div className="w-full max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-4">
            ...
            {label && (
              <span className="font-mono text-[11px] text-violet-light tracking-[0.22em] uppercase block">
                {label}
              </span>
            )}
          </div>
          ...
          {subheading && (
            <motion.p
              ...
              className="text-[17px] text-muted max-w-2xl leading-[1.65]"
            >
              {subheading}
            </motion.p>
          )}
      ...
      <div className="w-full max-w-[1440px] mx-auto px-6 lg:px-12 mt-16">
