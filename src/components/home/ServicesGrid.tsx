    ...
    <section className="w-full py-20 lg:py-28 dot-grid">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          ...
          subtitle="From websites to AI automation — we handle every layer of your digital infrastructure."
        />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, idx) => (
            <MotionWrapper
              key={service.slug}
              delay={idx * 0.06}
              className={cn(idx === services.length - 1 && services.length % 3 === 1 && 'lg:col-start-2')}
            >
