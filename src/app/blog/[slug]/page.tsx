  ...
  return (
    <main className="min-h-screen bg-canvas">
      ...
      <section className="py-24 bg-canvas">
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div 
            className="prose prose-invert prose-lg max-w-none
              ...
              prose-h2:text-3xl prose-h2:mt-16 prose-h2:mb-6 prose-h2:pb-4 prose-h2:border-b prose-h2:border-border
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-24 pt-12 border-t border-border">
          <Link 
            href="/blog" 
            className="inline-flex items-center justify-center px-6 py-3 border border-border text-sm text-white hover:border-violet hover:bg-violet transition-colors"
            data-cursor="pointer"
          >
            ← Back to Insight
          </Link>
