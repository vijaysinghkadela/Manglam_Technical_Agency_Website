...
export const services: Service[] = [
  ...
  },
  {
    ...
    Icon:        Share2,
    description: 'We run strategy-led social media execution with measurable reporting, content consistency, and channel selection based on business goals.',
    ...
    pricing: [
      {
        label: 'Starter', amount: '₹15,000', period: '/month', highlight: false,
        features: ['15 posts', '1 platform', 'Basic reporting'],
      },
      {
        label: 'Growth', amount: '₹30,000', period: '/month', highlight: true,
        features: ['30 posts', '2 platforms', 'Ad management support'],
      },
      {
        label: 'Premium', amount: '₹50,000+', period: '/month', highlight: false,
        features: ['Multi-platform execution', 'High-volume content', 'Full-service support'],
      },
    ],
    process: [
  ...
  },
  {
    ...
    Icon:        Shield,
    description: 'We identify vulnerabilities, map risk, and build practical remediation plans aligned with Indian and global compliance requirements.',
    ...
    priceLabel:  'From ₹50,000 (security audit)',
    ...
    pricing: [
      {
        label: 'Security Audit', amount: '₹50,000 - ₹2,00,000', period: 'one-time', highlight: true,
        features: ['Surface Threat Audit', 'Compliance Gap Check (GDPR/DPDP)', 'Immediate Risk Report'],
      },
      {
        label: 'Penetration Testing', amount: '₹1,00,000 - ₹5,00,000', period: 'project', highlight: false,
        features: ['Deep Penetration Testing', 'Architecture Hardening', 'Policy Drafting (NIST/ISO)', 'Employee Phishing Sims'],
      },
      {
        label: 'Compliance Consulting', amount: '₹75,000 - ₹3,00,000', period: 'project', highlight: false,
        features: ['DPDP/GDPR gap analysis', 'Policy planning', 'Implementation roadmap'],
      },
      {
        label: 'Incident Response', amount: '₹1,50,000+', period: 'emergency', highlight: false,
        features: ['Breach investigation', 'Containment support', 'Recovery guidance'],
      },
    ],
    process: [
