      ...
      <div className="container-site">
        <div className="mb-12 flex flex-col gap-5 lg:mb-16 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <h2
              className="marketing-heading font-display font-black tracking-normal leading-none"
              style={{ fontSize: 'clamp(1.8rem, 4vw, 3.4rem)', color: 'var(--color-foreground)' }}
            >
              Built to move from strategy to delivery without bloat.
            </h2>
            <p
              className="narrative-copy mt-5 max-w-[58ch]"
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="group relative flex h-full min-h-[300px] flex-col overflow-hidden rounded-[30px] glass-card p-8 shadow-[0_18px_60px_rgba(0,0,0,0.04)] transition-all duration-300 sm:p-10"
                  data-cursor="link"
                >
                  ...
                  <div className="relative mt-auto flex items-center justify-between gap-4 border-t border-border pt-6">
                    ...
                    <span className="inline-flex h-10 w-10 items-center justify-center rounded-full glass-card transition-all duration-300 group-hover:border-violet group-hover:bg-violet">
                      <ArrowRight
