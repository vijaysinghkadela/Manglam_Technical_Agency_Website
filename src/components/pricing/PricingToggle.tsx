  ...
  return (
    <div className="max-w-xs mx-auto flex items-center bg-surface rounded-xl p-1 border border-brand/15">
      ...
      <button
        ...
        className={`flex-1 px-4 py-3 rounded-lg text-sm font-medium transition-all duration-200 relative ${
      ...
      >
        Annual
        <span className="absolute -top-2 -right-2 px-2 py-1 bg-success text-white text-[10px] font-bold rounded-full">
          Save
        </span>
      </button>
    </div>
