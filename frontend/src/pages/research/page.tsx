...
export const metadata: Metadata = {
  title: 'Research: Indian Agency Landscape & Pipeline Strategy',
  description:
    'Public-safe research brief covering Indian agency categories, operating models, acquisition pipelines, gap analysis, and MTA growth strategy.',
}
      ...
      >
        ...
        <div className="relative z-10 container-site flex flex-col flex-1 pt-28 lg:pt-36 pb-12 lg:pb-16">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            >
              ✦ INTERNAL RESEARCH (PUBLIC REPORT)
            </span>
            ...
            >
              A structured view of Indian agency categories, operating models, acquisition patterns, and the specific growth actions that apply to Manglam Technical Agency.
            </p>
          </div>
