...
export function organizationSchema() {
  return {
    ...
    description:
      'End-to-end technology services for Indian businesses — AI automation, social media marketing, cybersecurity, and digital operations. Based in Rajasthan and registered under Udyam in 2025.',
    email: AGENCY_EMAIL,
